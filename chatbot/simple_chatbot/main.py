...
#     await cl.Message(content="Hello! I am a helpful assistant that can answer questions and provide support.").send()
...
#     # Store history with "agent" role for consistency
